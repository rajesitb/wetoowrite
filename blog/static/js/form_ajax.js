...
$("#id_pics").attr('multiple');
   $("#comment_data").on('submit',function(e){
//        e.preventDefault();
        var name = $("#id_name").val();
        console.log($(this).serialize());
        console.log(String.raw`${$("#id_pics").val()}`);
        $.ajax({
            url: '/comments/',
            type:'GET',
            data:{
...
//                'pics':$("#id_pics").val(),
            ...
            success: function(data){
                ...
                $('#ajax_comment').append("<p>Comment "+next_count+" By "+data['name']+" At: " +data['time']+ "</p>");
                $('#comment_body').append(data['body']);
            }
        });
    });
...
//        e.preventDefault();
//        console.log($(this).serialize());
//        console.log($('input[type="file"]').serialize());
//        var photo = $("#id_pics").val();
